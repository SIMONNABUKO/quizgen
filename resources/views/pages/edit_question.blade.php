...
<div id="edit-profile" class="tab-pane">
  <section class="panel">
    <div class="panel-body bio-graph-info">
      ...
      @endif
      <form class="form-horizontal" method="POST" action="{{ route('questions.update', ["id"=>$question->id])}}">
          @csrf
          <div class="form-group">
              <label class="col-lg-2 control-label">Question difficulty</label>
              <div class="col-lg-6">
                  <select name="difficulty" id="" class="form-control">
                    <option value="{{$question->difficulty}}" selected>{{$question->difficulty}}</option>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                  <select name="level" id="" class="form-control">
                    <option value="{{$question->level}}" selected>{{$question->level}}</option>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-6">
          <input type="text" class="form-control" name="subject" id="l-name" value="{{$question->subject}}" placeholder="Enter the subject">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-2 control-label">Question</label>
          <div class="col-lg-6">
          <textarea name="question" id="" class="form-control" cols="30" rows="5">{{$question->question}}</textarea>
          </div>
        </div>
       
      <input type="number" value="{{$question->user_id}}" name="user_id" hidden>
